...
function mapCafe(restaurantObject: { elements: { type: any; id: any; lat: any; lon: any; tags: any; }[]; }) {
    return restaurantObject.elements.map((element: { type: any; id: any; lat: any; lon: any; tags: any; }) => 
    {
        // sanitize restaurant tags
        const tags: TagMap = {};
...
function mapFastFood(restaurantObject: { elements: { type: any; id: any; lat: any; lon: any; tags: any; }[]; }) {
    return restaurantObject.elements.map((element: { type: any; id: any; lat: any; lon: any; tags: any; }) => 
    {
        // sanitize restaurant tags
        const tags: TagMap = {};
...
const placeFind = async (_req: any, res: { render: (arg0: string, arg1: {}) => void; }) => {
    ...
    if(_req.query.box != undefined && _req.query.box != '')
    {
        ...
        try{
            ...
            {
                case 'restaurant':
                    placeArray = mapRestaurant(placeResponse);
                break;
                case 'cafe':
                    placeArray = mapCafe(placeResponse);
                break;
                case 'fast_food':
                    placeArray = mapFastFood(placeResponse);
                break;
            }
